...
void meow::render() {
  ...
  for (bicudo::object *&p_objs : bicudo::app.world_manager.loaded_object_list) {
    ...
    meow::app.immediate.draw({p_objs->placement.max.x, p_objs->placement.max.y, 10.0f, 10.0f}, {0.0f, 0.0f, 1.0f, 1.0f}, 0.0f);

    meow::app.immediate.draw({p_objs->placement.vertices[0].x, p_objs->placement.vertices[0].y, 10.0f, 10.0f}, {1.0f, 0.0f, 1.0f, 1.0f}, 0.0f);
    meow::app.immediate.draw({p_objs->placement.vertices[1].x, p_objs->placement.vertices[1].y, 10.0f, 10.0f}, {1.0f, 0.0f, 1.0f, 1.0f}, 0.0f);
    meow::app.immediate.draw({p_objs->placement.vertices[2].x, p_objs->placement.vertices[2].y, 10.0f, 10.0f}, {1.0f, 0.0f, 1.0f, 1.0f}, 0.0f);
    meow::app.immediate.draw({p_objs->placement.vertices[3].x, p_objs->placement.vertices[3].y, 10.0f, 10.0f}, {1.0f, 0.0f, 1.0f, 1.0f}, 0.0f);
    meow::app.immediate.draw({rect.x + p_objs->placement.size.x / 2, rect.y + p_objs->placement.size.y / 2, 10.0f, 10.0f}, {1.0f, 0.0f, 1.0f, 1.0f}, 0.0f);
    */
  }
